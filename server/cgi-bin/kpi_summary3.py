...
#ターゲット数値取得
chqs = obj.getTargetNum(3, posts.month, posts.startdtstr, posts.clientid, posts.year)

#ターゲット店舗取得
shops = obj.getTargetShop(3, posts.startdtstr, posts.clientid, posts.startdtYearmonth, posts.enddtYearmonth)
...
for row in shops:
    ...
    sql = 'SELECT kpa_col1 FROM t_report report '\
        ...
        'AND kpq.kpq_delete = 0 AND kpq.kpq_disporder = 4 '\
